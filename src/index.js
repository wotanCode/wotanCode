...
import { YOUTUBE_WOTANCODE_CHANNEL_ID, NUMBER_OF, PLACEHOLDERS } from './constants.js'

const {
  YOUTUBE_API_KEY
} = process.env

const getLatestYoutubeVideos = ({ channelId } = { channelId: YOUTUBE_WOTANCODE_CHANNEL_ID }) =>
  fetch(
